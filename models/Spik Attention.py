...
class Spikformer(nn.Module):
    def __init__(self,
                 inputs=128, outputs = 100, depths=1, qkv_bias=False, qk_scale=None,drop_rate=0., attn_drop_rate=0.,  mlp_ratios=4, drop_path_rate=0., norm_layer=nn.LayerNorm, sr_ratios=[8, 4, 2]
                 ):
        super().__init__()
